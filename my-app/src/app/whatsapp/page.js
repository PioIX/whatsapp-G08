                      ...
                      <div className="pt-3 pe-3" style={{ position: 'relative', height: '400px', overflowY: 'auto' }}>
                        ...
                        {[
                          ...
                          <div className={`d-flex flex-row justify-content-${msg.sent ? 'end' : 'start'}`} key={index}>
                            {!msg.sent && (
                              <img
                                src={`https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/${msg.avatar}`}
                                alt="avatar"
                                style={{ width: '45px', height: '100%' }}
                              />
                            )}
                            <div>
                              <p className={`small p-2 ${msg.sent ? 'me-3' : 'ms-3'} mb-1 rounded-3 ${msg.sent ? 'bg-primary text-white' : 'bg-body-tertiary'}`}>
                                {msg.message}
                              </p>
